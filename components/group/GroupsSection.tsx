    ...
    <View className="px-5 py-3">
      ...
      <View className="flex-row justify-between items-center mb-3">
        ...
        >
          ...
          <Ionicons name="arrow-forward" size={14} color="#7B9E87" />
        </Pressable>
      </View>
      ...
      {isLoading ? (
        <View className="h-32 bg-background rounded-2xl items-center justify-center border border-gray-700">
          <Ionicons name="hourglass-outline" size={32} color="#7B9E87" />
        </View>
      ) : !user?.is_premium ? (
        <View className="bg-background rounded-2xl p-5 border border-purple/30">
          <View className="flex-row items-center mb-3">
            <View className="bg-purple/20 p-3 rounded-full mr-3">
              <Ionicons name="people" size={24} color="#7B9E87" />
            </View>
        ...
        <View className="bg-background rounded-2xl p-5 items-center border border-gray-700">
          <Ionicons name="people-outline" size={36} color="#7B9E87" />
          ...
          {groups.map((group, index) => (
            ...
            >
              ...
              <View className="p-3">
                ...
                <View className="flex-row items-center">
                  <Ionicons name="people" size={14} color="#7B9E87" />
