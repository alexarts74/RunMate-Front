...
const HomepageScreen = () => {
  ...
  const getCompatibilityScore = (match: any) => {
    const { pace_match, distance_match, availability_match } = match.compatibility_details;
    return pace_match + distance_match + availability_match;
  };
              ...
              <View className="ml-4 flex-1">
                ...
                <View className="flex-row mt-2">
                  <Text className="text-orange-500">
                    Compatibilité: {getCompatibilityScore(match)}/60
                  </Text>
                </View>
